...
housing = pd.read_csv("D:/HOC_MAY/Project_cuoiki/source/End_to_End_Project/CaliHousing/housing.csv")
...
# Save model lin_reg 
joblib.dump(lin_reg, "D:/HOC_MAY/Project_cuoiki/source/End_to_End_Project/CaliHousing/model_lin_reg.pkl")
...
pre1 = lin_reg.predict(some_data_prepared)
